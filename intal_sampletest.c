...
int main(int argc, char const *argv[]) {
	...
	result1 = intal_add("64","960");
	if(!result1) {
		printf("Test intal_add FAILED.\n");
	} else {
		if(0 == strcmp(result1, "1024")) {
			printf("Test intal_add PASSED\n");
		} else {
			printf("Test intal_add FAILED.\nYour answer: %s\nExpected answer: %s\n", result1, "1024");
		}
	...
	result1 = intal_diff("1234512345123451232416437", "12");
	if(!result1) {
		printf("Test intal_diff FAILED.\n");
	} else {
		if(0 == strcmp(result1, "1234512345123451232416425")) {
			printf("Test intal_diff PASSED\n");
		} else {
			printf("Test intal_diff FAILED.\nYour answer: %s\nExpected answer: %s\n", result1, "1234512345123451232416425");
		}
		free(result1);
	}
